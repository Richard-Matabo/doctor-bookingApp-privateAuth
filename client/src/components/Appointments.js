...
const Patients = () => {
  ...
  const [selectedAppointment, setSelectedAppointment] = useState(null); // State to store the selected appointment for editing
      ...
      <div className='Appointments'>
        ...
        <ul>
          {appointments.map((appointment) => (
            <li key={appointment._id} style={{ backgroundColor: appointment.confirmed ? 'lightblue' : '#cdeb'  }}>
